...
4. Análises uni/bivariadas: correlação, multicolinearidade, box-plot & Análise exploratória; Modelo inicial (VIF) \\
5. Modelo inicial com todas as variáveis explicativas & Modelo inicial: todas as variáveis explicativas \\
6. Seleção do melhor modelo por critério estatístico & Seleção do modelo final \\
